...
def train(model, train_loader, valid_loader, optimizer, loss_fn, scaler, device, config, ct_augment, half):
    data_save_path = f'C:/Users/Josh/Desktop/4YP/baseline_results/LiveAugment/models/{config.training_set}/half_{half}'
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep=sweep_config, project="Baseline_LiveAugment_ST&SSD")
